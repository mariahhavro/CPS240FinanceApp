...
/**
 * 
 * This class is the class used to run the application. It combined all other classes associated with the app
 * into a tabbed pane.
 *
 */
...
public class Menu extends JFrame {
	...
	/**
	 * This method creates the overall menu of the app and the different options/tools the user can choose from.
	 */
	public Menu() {
	...
	/**
	 * This method loads a list of users 
	...
	/**
	 * This method is used to find a specific user in a list of users
	 * @param username
	 * @param password
	 * @return user
	 */
